...
public record UpdateResumeDto(string? FullName, string? Email, string? PhoneNumber, string? Address, string? City, List<EducationDto?>? Educations, List<SkillsDto?>? Skills, List<ExperienceDto?>? Experiences, string? Position, DateTime? YearOfBirth, string? Summary);
