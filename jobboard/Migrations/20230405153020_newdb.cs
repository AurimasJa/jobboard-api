        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalaryFrom = table.Column<double>(type: "float", nullable: false),
                    SalaryTo = table.Column<double>(type: "float", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyOffers = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Location = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    City = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Salary = table.Column<double>(type: "float", nullable: false),
                    RemoteWork = table.Column<bool>(type: "bit", nullable: false),
                    TotalWorkHours = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompaniesResumes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompaniesResumes_AspNetUsers_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CompaniesResumes_Resumes_ResumeId",
                        column: x => x.ResumeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobResumes_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JobResumes_Resumes_ResumeId",
                        column: x => x.ResumeId,
                        principalTable: "Resumes",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompaniesResumes_CompanyId",
                table: "CompaniesResumes",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompaniesResumes_ResumeId",
                table: "CompaniesResumes",
                column: "ResumeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobResumes_JobId",
                table: "JobResumes",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_JobResumes_ResumeId",
                table: "JobResumes",
                column: "ResumeId");
