...
public record UpdateCompanyDto(string? Name, string? Email, string? Surname, string? Password, string? NewPassword, string? City, string? Address, string? Site, string? PhoneNumber, string? CompanyName, string? CompanyCode, string? AboutSection);
public record SuccessfulLoginDto(string AccessToken);
public record RegisterCompanyDto([Required(ErrorMessage = "Vardas yra privalomas.")] string Name, [Required(ErrorMessage = "Pavardė yra privaloma")] string Surname, [Required(ErrorMessage = "Telefono numeris yra privalomas")] string PhoneNumber, [Required(ErrorMessage = "El. paštas yra privalomas")] string Email, [Required(ErrorMessage = "Slaptažodis yra privalomas")] string Password, [Required(ErrorMessage = "Šis laukas yra privalomas")] string AboutSection, [Required(ErrorMessage = "Adresas yra privalomas")] string Address, [Required(ErrorMessage = "Miestas yra privalomas")] string City, [Required(ErrorMessage = "Kompanijos kodas yra privalomas")] string CompanyCode, [Required(ErrorMessage = "Kompanijos pavadinimas yra privalomas")] string CompanyName, string? Site);
